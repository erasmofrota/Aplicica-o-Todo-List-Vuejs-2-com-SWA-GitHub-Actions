  ...
  <div id="app">
    <div class="ui inverted vertical masthead center aligned segment">
      <div class="ui text container">
        ...
        <h2 class="ui inverted header">Erasmo Frota
          <div class="sub header"></div>
        </h2>
        <h3 class="ui inverted header">Ceará, Brasil - 2020</h3>
        <!-- <a class="tiny ui youtube button" type="button" href="https://www.youtube.com/user/l32759">
          <i class="youtube icon"></i>
          YouTube
        </a> -->
        <a class="tiny ui linkedin button" type="button" href="https://www.linkedin.com/in/erasmo-frota-a3467a18/">
